		...
		<!-- wcf-bump-order-field-wrap -->
			<div class="wcf-bump-order-field-wrap">
				<label>
					...
					<input type="checkbox" class="wcf-bump-order-cb" name="wcf-bump-order-cb" value="<?php echo $product_id; ?>" id="wcf-bump-order-cb"<?php checked( $order_bump_checked, true, true ); ?> data-ob_data="<?php echo htmlentities($bump_offer_data) ?>" >
