...
<div class="wcf-bump-order-wrap default">
	...
	<div class="wcf-bump-order-field-wrap wcf-bump-order-<?php echo $order_bump_data['id']; ?>">
		<label>
			...
			<input type="checkbox" class="wcf-bump-order-cb" name="wcf-bump-order-cb" value="<?php echo $product_id; ?>" id="wcf-bump-order-cb"<?php checked( $order_bump_checked, true, false ); ?> data-ob_data="<?php echo htmlentities($bump_offer_data) ?>" >
